package com.imooc.scbo2o.config.redis;

import com.imooc.scbo2o.cache.JedisPoolWriper;
...
public class RedisConfiguration {
    ...
    public JedisPoolConfig createJedisPoolConfig() {
        ...
        //最大等待时间：当没有可用连接时
        //连接池等待连接北归还的最大时间（以毫秒计数），超过时间则抛出异常
    ...
    public JedisUtil.Strings createJrdisStrings() {
